// near api js
import { providers, keyStores, KeyPair, Account, connect } from "near-api-js";
...
export class Wallet {
  ...
  // selectedWallet = async () => {
  //   return (selectedWallet = await await this.selector.connectedWalletAccount);
  // };
